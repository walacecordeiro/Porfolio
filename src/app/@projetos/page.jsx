 ...
 return (
  ...
  >
   <div class="sticky top-0 z-20 -mx-6 mb-4 w-screen bg-slate-900/75 px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:static lg:bg-transparent lg:w-full lg:py-0 lg:pb-5">
    <h2 class="text-sm font-bold uppercase tracking-widest text-slate-200">Projetos</h2>
   </div>
   <div>
    <ul class="group/list">
     <li class="mb-12">
      ...
      <div class="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
       ...
       <div class="z-10 sm:order-2 sm:col-span-6">
        ...
        <a
         ...
         target="_blank"
         rel="noreferrer noopener"
         aria-label="639 stars on GitHub (opens in a new tab)"
        >
         <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
      ...
      <div class="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
       ...
       <div class="z-10 sm:order-2 sm:col-span-6">
        ...
        <a
         ...
         target="_blank"
         rel="noreferrer noopener"
         aria-label="7417 stars on GitHub (opens in a new tab)"
        >
         <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
