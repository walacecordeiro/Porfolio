...
export default function RootLayout({ children }) {
 return (
  <html lang="pt-br">
   <body
    className={`${inter.className} dark w-[88%] mx-auto py-12 bg-[#0F172A] text-slate-400 lg:grid lg:grid-cols-2 lg:py-0 lg:w-4/5`}
   >
    <MouseMove />
    ...
    <header className="lg:sticky lg:top-0 lg:h-screen lg:py-24">
     ...
     <p className="mt-4 max-w-xs leading-normal">
      Aqui irá uma bela frase de efeito para combinar com o perfil.
     </p>
