export function SectionSticky({ title, normalCaseOnMobile, className, children }) {
 return (
  <section className={`${className}`}>
   {title && (
    <div className="sticky top-0 z-20 -mx-6 w-screen bg-background px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:static lg:bg-transparent lg:w-fit lg:p-0 lg:mb-7">
     <h2
